---
title: Fail Fast
subtitle: I have not failed, I've just found 10000 ways that don't work 
layout: pattern
type: build
show-avatar: no
excerpt_separator: <!--more-->
---
Quicker steps should occur faster in the build cycle so that feedback can be 
delivered quicker on failure.  Some users have CI jobs that produce feedback on
simple build and test and have seperate release candidate jobs that add
additional testing and publish artifacts.  But couldn't this be in one single pipeline?
